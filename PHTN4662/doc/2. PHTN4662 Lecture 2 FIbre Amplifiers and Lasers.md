...
- [Laser basics](#laser-basics)
  - [Laser Principle](#laser-principle)
    - [Interaction between matter and light](#interaction-between-matter-and-light)
...
- Interaction process between an atom and radiation #star
...
- #star $\Delta E=hv=E_2-E_1$
- State population - Boltzmann Distribution #star
...
- Energy Level Diagram
  > ![Energy_Level_Diagram](../images/2-Energy_Level_Diagram.png)
- Population-inversion #star
...
- Threshold gain coefficient [neper/cm] #star
...
- Criteria for optical gain medium #star
...
- Electronic amplifiers and regenerators #star
...
- Partial energy levels of Erbium in silica #star
...
- Key issues of Erbium doped fiber amplifiers (EDFAs)
  - Absorption and emission of light #star
...
> #star ![Lasing_characteristic](../images/2-Lasing_characteristic.png)
