...
- Carrier diffusion & Recombination
  ...
  | --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- |
  | ![PN_open_circuit](../images/2-PN_open_circuit.png) | ![PN_reverse_bias](../images/2-PN_reverse_bias.png) | ![PN_forward_bias](../images/2-PN_forward_bias.png) |

  - properties & features
    > ![PN_properties_features](../images/2-PN_properties_features.png)
...
amount of photons.  
> ![Energy_diagram_hetero](../images/2-Energy_diagram_hetero.png) 
## Double Heterojunction
> ![Double_hetero](../images/2-Double_hetero.png)
...
- From V-I and P-I curves, we can work out the power efficiency of 
  ...
  | V-I Curve                             | P-I curve                             |
  | ------------------------------------- | ------------------------------------- |
  | ![VI_curve](../images/2-curve_VI.png) | ![PI_curve](../images/2-curve_PI.png) |
...
- For LED, it is not very efficient in directly launching its output 
  ...
  | ----------------------------------------------------------- | ----------------------------------------------------------- |
  | ![LED_normal](../images/2-Radiation_pattern_normal_LED.png) | ![LED_lensed](../images/2-Radiation_pattern_lensed_LED.png) |
...
- The electrical bandwidth $BW_{el}$ can be calculated from 
  $BW_{opt}$ by  
  - $BW_{el}=0.707BW_{opt}$
- ![Measurement_time_response](../images/2-Measurement_time_response.png)
...
- The output optical power usually decreases with temperature. It is 
  ...
  | -------------------------------------------------------------- | ------------------------------------------------------------ |
  | ![Emission_wavelength](../images/2-Temperature_wavelength.png) | ![Relative_intensity](../images/2-Temperature_intensity.png) |
## Laser Diode
...
| ------------------------------------------- | ------------------------------------------------- | ------------------------------------------------- |
| ![Laser_diode](../images/2-Laser_diode.png) | ![VI_curve_diode](../images/2-curve_VI_diode.png) | ![Laser_chirping](../images/2-curve_chirping.png) |
...
- Front-illuminated PIN photodiode.
  > ![Front-illuminated_PIN](../images/2-Front-illuminated_PIN.png)
...
we need to apply a high voltage across the pn junction of the diode
  ...
  > ![APD](../images/2-Avalanche_Photodiode.png)
