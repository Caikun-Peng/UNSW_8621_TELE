...
- Carrier diffusion & Recombination #star
  ...
  | --------------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- |
  | ![PN_open_circuit](../images/3-PN_open_circuit.png) | ![PN_reverse_bias](../images/3-PN_reverse_bias.png) | ![PN_forward_bias](../images/3-PN_forward_bias.png) | #star |

  - properties & features #star
...
amount of photons.  
> #star ![Energy_diagram_hetero](../images/3-Energy_diagram_hetero.png) 
## Double Heterojunction
- It is noted that light generation in a heterojunction semiconductor material occurs within the n-type, in fact, it can occur any where within it. This also becomes inefficient because some of light may be absorbed.
- However, we also need to consider the light guidance effect of the structure. Since light is generated within the GaAs strip, we want the light to be confined within this strip and propagate out of the device from here. 
- We do not want light to go into the neighbouring GaAlAs materials. Hence the refractive index of the GaAs must be larger than those of its neighbour. 
- #star To solve the problem, we should confine the light generation region within a small strip of the action region. This is achieved by the introduction another n-type material to the right of the n-type GaAs. In this way, the n-type GaAs strip can be made small.
- This structure is called double heterojunction structure and is the basic construction for both light emitting diodes and laser diodes. 
...
| Laser Diode                                 | V-I Curve #star                                   | Laser Chirping #star                              |
| ------------------------------------------- | ------------------------------------------------- | ------------------------------------------------- |
...
- #star A PIN photodiode has an intrinsic layer between the pn junction. 
...
- Front-illuminated PIN photodiode.
  > #star ![Front-illuminated_PIN](../images/3-Front-illuminated_PIN.png)
...
#star APD could have both very large bandwidth and very high gain.
