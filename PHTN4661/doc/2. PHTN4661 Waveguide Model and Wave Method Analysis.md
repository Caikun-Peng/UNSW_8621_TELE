...
- The Graph of TE and TM modes
	![TE&TM Modes](../images/TE&TM_Modes.png)
...
$$ \frac{\partial^2}{\partial R^2}E_z + \frac{1}{R}\frac{\partial}{\partial R}E_z + \left(U^2 - \frac{m^2}{R^2}\right)E_z = 0\\ \frac{\partial^2}{\partial R^2}E_z + \frac{1}{R}\frac{\partial}{\partial R}E_z - \left(W^2 + \frac{m^2}{R^2}\right)E_z = 0 $$
